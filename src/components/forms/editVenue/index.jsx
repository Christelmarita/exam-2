      ...
      try {
        ...
        if (response.ok) {
          ...
          setFormData({
            ...
            imageUrl: venue.media && venue.media.length > 0 ? venue.media[0].url : "",
            price: venue.price,
  ...
  return (
    <div>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <FormGridContainer>
          <FormItemCheckbox>
            <input type="checkbox" id="parking" checked={formData.amenities.parking} onChange={handleChange} />
            <label htmlFor="parking">Parking</label>
          </FormItemCheckbox>
          <FormItemCheckbox>
            <input type="checkbox" id="breakfast" checked={formData.amenities.breakfast} onChange={handleChange} />
            <label htmlFor="breakfast">Breakfast</label>
          </FormItemCheckbox>
          <FormItemCheckbox>
            <input type="checkbox" id="wifi" checked={formData.amenities.wifi} onChange={handleChange} />
            <label htmlFor="wifi">Wifi</label>
          </FormItemCheckbox>
          <FormItemCheckbox>
            <input type="checkbox" id="pets" checked={formData.amenities.pets} onChange={handleChange} />
